// src/pages/Rankings/TopAssists.jsx
...
export default function TopAssists() {
  ...
  useEffect(() => {
    fetch("/data/assists.json")
      .then((res) => res.json())
      .then((data) => setAssisters(data))
  ...
  return (
    <div className="bg-[#184171] min-h-screen">
      <div className="max-w-5xl mx-auto p-6 text-white">
        <h1 className="text-2xl font-bold mb-4">Top Assists</h1>
        <p className="text-gray-300 mb-6">
          Players ranked by total assists in FIFA World Cup 2026.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {assisters.map((p) => (
            ...
            >
              ...
              <div className="text-sv-gold mt-2 font-bold">Assists: {p.assists}</div>
            </div>
          ))}
        </div>
      </div>
